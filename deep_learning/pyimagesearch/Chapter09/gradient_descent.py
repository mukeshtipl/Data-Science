...
print("x,train_x.shape,w.shape:",x,train_x.shape,w.shape, w)
...
for epoch in np.arange(0, args['epochs']):
    ...
    print("p,y",predictions[1],train_y[1])
    ...
    if epoch == 0 or (epoch+1) % 5 == 0:
        ...
        #print(predictions.shape,predictions[0:2])
...
plt.scatter(test_x[:, 0], test_x[:, 1], marker='o', c=test_y.reshape(test_y.shape[0]), s=30)
#plt.scatter([1,2,3],[4,5,6],c=[0,1,0])

print(test_y.reshape(test_y.shape[0]))
